          ...
          child: Column(
            children: [
              ...
              Container(
                width: 96,
                height: 96,
                decoration: const BoxDecoration(color: AppColor.successContainer, shape: BoxShape.circle),
                child: const Icon(Icons.check_rounded, color: AppColor.onSuccessContainer, size: 56),
              ),
              const SizedBox(height: 20),
              const Text(
                'Pembayaran Berhasil',
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: AppColor.onSurface),
              ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Rincian Pembayaran',
            style: TextStyle(fontSize: 15, fontWeight: FontWeight.w800, color: AppColor.onSurface),
          ),
          ...
          if (sale.notes != null && sale.notes!.isNotEmpty) _row('Catatan', sale.notes!),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppColor.onSurface)),
        ],
      ),
    );
  }
